...
%TODO Workplace studies book Luff2000
...
%Additionally, it can be difficult for researchers outside of the industry to contribute developments that
...
% share with researcher who don't have access
...
as it occurs'' and criticise the use of interviews and questionnairres. They point out that a researcher cannot know in
...
whether it suits the story-line of the documentary.  Most interviews are recorded face-to-face, either on-location or
in a studio, depending on the situation.  During interviews, the Presenter asks the questions while the Producer
records the audio and monitors the levels.  For on-location interviews, the Presenter holds the microphone and the
Producer operates the portable recorder.
...
their production workflow was digital, and transfering between the paper and digital representations was a manual
...
To ensure our system fulfills the real-life requirements of radio production, we will evaluate it for use in the
