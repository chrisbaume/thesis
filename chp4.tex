...
%TODO Estimating time slot - could be assisted

% Searching through audio:
%Application of segmentation or
...
%recognised, but there is not enough time to transcribe the whole clip.
%Speech-to-text technology would be able to
