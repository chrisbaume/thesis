...
Now that we have a general understand of some common semantic audio features, we will see how they have been used for
...
audio analysis that are used later in this thesis: speech/music discrimination, speaker diarization and ASR.
...
used to enable automated information searching and indexing \citet{Kinnunen2010}. Speaker recognition relies on access
...
\begin{figure}[p]
  ...
  from \citet{Mason2007}.]{False colour audio visualization of an episode of the BBC radio programme ``From Our Own
    ...
    false colour visualization, but not the waveform.}
  \label{fig:Mason2007}
\end{figure}
