...
creative and technical endeavour that combines complex audio technology with artistic taste and judgement
...
chapter, we review methods, systems and technologies that are related to the production of radio and the development of
the semantic audio production tools in this thesis.
...
This shortage of studies may be a result of the limited number of radio producers, and their demanding workload, which
can make it challenging to recruit them for academic research. For example, \citet{Kim2003} worked with National Public
