...
% What hasn't been done
Our primary aim is to develop better tools for radio production. We believe that to achieve this, we first need to have
a solid understanding of the radio production process.  The author of this thesis is an employee of BBC R\&D, which
gives us extraordinary access to the resources of BBC Radio. This is unusual in academic research, where studies are
often conducted with student participants and under laboratory conditions.  Therefore, we will start our research by
using this position within the BBC to investigate how radio programmes are created.  This will allow us to be better
informed about the tasks and challenges involved, which will guide our design choices.  This will also allow us to take
advantage of access available to us that other researchers would not have.
