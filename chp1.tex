...
to assist the navigation and editing of lecture recordings using custom video editing software \citep{Loviscach2011}.
...
\begin{itemize}
  \item Chapter~\ref{chp:ethno}: 
    A set of theoretical models of audio editing workflows in professional radio production, based on empirical
    evidence.
...
\begin{itemize}
  ...
  \item Chapter~\ref{chp:screen}: Journal paper submitted and currently under review
  \item Chapter~\ref{chp:paper}: Journal paper submitted and currently under review 
\end{itemize}
