...
The digital pens that use this patented technology \citep{Fahraeus2003} are exclusively manufactured and licenced by
...
\begin{figure}[h]
  ...
  \caption{Design of the paper prototype. Words are selected by drawing in the box beneath the word, and removed by
  drawing over the word. A whole line is selected by drawing in the box to the right. Timestamps are shown on the left.
  Speaker turns are labelled with the speaker ID and coloured by gender. Words with a low confidence score are shaded.}
...
platform did not allow us to combine underlining and strikethrough gestures with handwriting recognition, we could not
...
the word to detect underlining. Drawing inside one of these these zones would mark that word as either removed or
selected, respectively.  We lightly shaded the zone below each word to make the boundary visible.
...
\begin{table}[h]
  ...
  \begin{tabular}{l l l}
      \hline
      \textbf{ID} & \textbf{Experience (years)} & \textbf{Department} \\ %& \textbf{Computer literacy} \\
      \hline
      P1 & 13 & Current affairs \\%& Medium  \\
      P2 & 16 & Documentaries   \\%& Low     \\
      P3 & 8 & Current affairs \\%& High    \\
      P4 & 10 & Science         \\%& High    \\
      P5 & 18 & Current affairs \\%& Low     \\
      P6 & 16 & Current affairs \\%& Medium  \\
      P7 & 28 & Documentaries   \\%& Medium  \\
      P8 & 20 & Science         \\%& Low     \\
      \hline
  \end{tabular}
