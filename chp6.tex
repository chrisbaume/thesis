...
P2 said they found the speaker diarization to be \textit{``distracting''}, particularly when it was inaccurate.
...
% listening/playback
Several participants noted the importance of listening to the recording and expressed a desire to hear the content
whilst reading the paper transcript.

% highlighting
P3, P4 and P5 remarked that they often mark more important bits of transcripts using asterisks or stars.
P1 and P3 also suggested that something could be highlighted by underlining twice.
It was also suggested that the side boxes could be used to rate or star a selection.
...
We started by observing which gestures the producers used to edit the transcript when not given any directions. The
most popular gestures were underline, strikethrough and drawing a line down the side of the page. These gestures
corresponded with our initial design for the prototype. Other gestures that participants used include in/out marks and
lasso for selection, and drawing a line through a paragraph for deletion. Handwritten text was also used to make
corrections to the transcript, and to label parts of the transcript.

There were mixed but strong opinions on whether it was better to select good content or remove bad content.
Most participants used a mixture of both approaches when undirected. Given the lack of consensus, it would be best to
give producers the option to do both, but this raises the issue of what should happen when a word is both selected and
...
then the other is used to select/delete smaller words or chunks within the larger ones. Our results indicate that
selecting large chunks is more popular than deletion. Also, there is likely to be more interest in removing individual
words, such as for `de-umming', than there is for selecting individual words. This suggests that it may be better for
delete to override select.
