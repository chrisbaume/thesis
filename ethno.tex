...
want to learn more to gain access. Books \cite{Hausman2012} and studies
\cite{Dunaway2000} on radio production have been written, but as they focus on
...
algorithms for speech/music discrimination \cite{Wieser2014} and speaker
diarization \cite{AngueraMiro2012} are relatively mature and have already been
applied to radio \cite{Raimond2014}. Experiments into the use of
higher-level representations like text are starting to appear, such as the
video editors from Loviscach \cite{Loviscach2011a} and Hyperaudio
\cite{Boas2012}.  However, without a detailed understanding of the production
...
diarization is fairly mature \cite{AngueraMiro2012} and although it is starting
to be used in some experimental BBC services such as the World Service Archive
\cite{Raimond2014}, it has yet to become available any mainstream production
tools.
