...
%In Chapter~\ref{sec:ethno}, we found that the participants preferred to work with text-based representations of audio,
...
%using grounded theory \citep{Silverman2016}
...
%parts are relevant. As we saw in Chapter~\ref{sec:ethno}, some programmes that are under particular time pressure will
