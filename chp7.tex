...
%Chapter~\ref{sec:ethno} used ethnographic case studies to investigate audio editing workflows for the production of a
...
%One of the findings from Chapter~\ref{sec:ethno} was that the observed radio producers used paper to allow for
%handwritten annotation and to facilitate face-to-face collaboration.
%Chapter~\ref{sec:paper}:
